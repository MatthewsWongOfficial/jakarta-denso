...
function BlogCardSkeleton() {
  return (
    <div className="relative p-[2px] rounded-3xl bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200 shadow-lg">
      <div className="bg-white rounded-3xl overflow-hidden">
        <div className="aspect-[16/10] sm:aspect-[4/3] relative bg-gray-200 animate-pulse">
          <div className="absolute inset-0 bg-gradient-to-t from-gray-900/90 via-gray-900/50 to-transparent">
            <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
              <div className="w-24 h-6 bg-gray-300 rounded-full mb-2 animate-pulse"></div>
              ...
              <div className="flex items-center mt-2">
                <div className="w-4 h-4 bg-gray-300 rounded-full mr-2 animate-pulse"></div>
