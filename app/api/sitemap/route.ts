...
export async function GET(): Promise<NextResponse> {
  try {
    ...
    const staticPages: PageInfo[] = [
      ...
      { url: "/harga", priority: "0.9", changefreq: "weekly", lastmod: "2025-02-01" },
      { url: "/gallery", priority: "0.8", changefreq: "weekly", lastmod: "2025-02-01", hasImages: true},
      { url: "/ulasan-kami", priority: "0.8", changefreq: "weekly", lastmod: "2025-02-15", hasImages: true },
      { url: "/kontak-kami", priority: "0.7", changefreq: "monthly", lastmod: "2025-02-10", hasImages: true },
